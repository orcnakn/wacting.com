...
const CAMPAIGN_TEMPLATES: CampaignTemplate[] = [
  ...
  // ─── Extra campaigns to reach 200 total ────────────────────────────────────
  // Entrepreneurs (15)
  { title: 'Startup Founders Hub', slogan: 'Build Bold', description: 'Connecting startup founders for mentorship and resources.', category: 'tech', iconColor: '#FF5722', speed: 0.8, stakeAmount: 6 },
  { title: 'Women In Business', slogan: 'Lead With Power', description: 'Supporting women entrepreneurs with funding and mentorship.', category: 'community', iconColor: '#E91E63', speed: 0.6, stakeAmount: 5 },
  { title: 'Small Biz Alliance', slogan: 'Local First', description: 'Protecting small businesses from corporate overreach.', category: 'politics', iconColor: '#FF9800', speed: 0.4, stakeAmount: 4 },
  { title: 'Creator Economy Fund', slogan: 'Create And Earn', description: 'Empowering digital creators with fair monetization.', category: 'tech', iconColor: '#9B59B6', speed: 0.7, stakeAmount: 5 },
  { title: 'Freelancer Protection', slogan: 'Fair Pay Fair Work', description: 'Legal protections and benefits for freelance workers.', category: 'politics', iconColor: '#2196F3', speed: 0.5, stakeAmount: 4 },
  { title: 'Rural Internet Access', slogan: 'Connect Every Town', description: 'Broadband internet for rural communities.', category: 'tech', iconColor: '#00BCD4', speed: 0.3, stakeAmount: 6 },
  { title: 'Green Startup Fund', slogan: 'Eco Innovation', description: 'Funding environmentally sustainable startups.', category: 'env', iconColor: '#4CAF50', speed: 0.6, stakeAmount: 7 },
  { title: 'Minority Business Grant', slogan: 'Equal Opportunity', description: 'Grants and support for minority-owned businesses.', category: 'community', iconColor: '#795548', speed: 0.4, stakeAmount: 5 },
  { title: 'Gig Workers United', slogan: 'Fair Gig Economy', description: 'Better conditions for gig economy workers.', category: 'politics', iconColor: '#607D8B', speed: 0.5, stakeAmount: 3 },
  { title: 'Trade School Revival', slogan: 'Skills Not Debt', description: 'Reviving trade education as an alternative to college.', category: 'community', iconColor: '#FF5722', speed: 0.4, stakeAmount: 4 },
  { title: 'Cooperative Business Model', slogan: 'Own Together', description: 'Promoting worker-owned cooperative businesses.', category: 'community', iconColor: '#009688', speed: 0.3, stakeAmount: 5 },
  { title: 'Veteran Entrepreneurs', slogan: 'Service To Business', description: 'Helping military veterans start businesses.', category: 'community', iconColor: '#3F51B5', speed: 0.5, stakeAmount: 6 },
  { title: 'Social Enterprise Network', slogan: 'Profit With Purpose', description: 'Building businesses that solve social problems.', category: 'community', iconColor: '#8BC34A', speed: 0.6, stakeAmount: 4 },
  { title: 'Micro Lending Circle', slogan: 'Small Loans Big Dreams', description: 'Community-based micro-lending for aspiring entrepreneurs.', category: 'community', iconColor: '#FFC107', speed: 0.3, stakeAmount: 3 },
  { title: 'Food Truck Alliance', slogan: 'Street Eats Unite', description: 'Supporting food truck owners with regulations and locations.', category: 'community', iconColor: '#FF9800', speed: 0.7, stakeAmount: 2 },
  // Students & Education (15)
  { title: 'Student Debt Relief', slogan: 'Free To Learn', description: 'Advocating for student loan forgiveness and reform.', category: 'politics', iconColor: '#2196F3', speed: 0.5, stakeAmount: 4 },
  { title: 'STEM For Girls', slogan: 'She Can Code', description: 'Encouraging girls to pursue STEM education.', category: 'tech', iconColor: '#E91E63', speed: 0.6, stakeAmount: 3 },
  { title: 'Campus Mental Health', slogan: 'Mind Matters', description: 'Better mental health resources on college campuses.', category: 'community', iconColor: '#9C27B0', speed: 0.4, stakeAmount: 5 },
  { title: 'Free Textbooks Project', slogan: 'Knowledge Is Free', description: 'Open source textbooks for every student.', category: 'tech', iconColor: '#3498DB', speed: 0.5, stakeAmount: 2 },
  { title: 'After School Programs', slogan: 'Keep Kids Safe', description: 'Free after-school activities for latchkey children.', category: 'community', iconColor: '#FF9800', speed: 0.3, stakeAmount: 4 },
  { title: 'Special Education Rights', slogan: 'Every Child Learns', description: 'Better funding and support for special education.', category: 'politics', iconColor: '#4CAF50', speed: 0.4, stakeAmount: 5 },
  { title: 'College Access Alliance', slogan: 'Doors Wide Open', description: 'First-generation college student support programs.', category: 'community', iconColor: '#FF5722', speed: 0.5, stakeAmount: 3 },
  { title: 'Teacher Pay Campaign', slogan: 'Pay Our Teachers', description: 'Competitive salaries for public school teachers.', category: 'politics', iconColor: '#F44336', speed: 0.6, stakeAmount: 6 },
  { title: 'School Lunch Reform', slogan: 'Healthy Kids', description: 'Nutritious free meals for all students.', category: 'community', iconColor: '#8BC34A', speed: 0.3, stakeAmount: 3 },
  { title: 'Arts In Schools Fund', slogan: 'Create Express', description: 'Restoring arts education budgets in public schools.', category: 'arts', iconColor: '#E91E63', speed: 0.4, stakeAmount: 4 },
  { title: 'Bilingual Education', slogan: 'Two Tongues', description: 'Promoting bilingual education programs nationwide.', category: 'community', iconColor: '#00BCD4', speed: 0.5, stakeAmount: 3 },
  { title: 'School Safety Alliance', slogan: 'Safe To Learn', description: 'Evidence-based school safety measures.', category: 'politics', iconColor: '#607D8B', speed: 0.4, stakeAmount: 5 },
  { title: 'Youth Coding Bootcamp', slogan: 'Debug The Future', description: 'Free coding bootcamps for teens in underserved areas.', category: 'tech', iconColor: '#673AB7', speed: 0.7, stakeAmount: 4 },
  { title: 'Library Maker Spaces', slogan: 'Build Learn Create', description: 'Adding maker spaces to public libraries.', category: 'community', iconColor: '#795548', speed: 0.3, stakeAmount: 3 },
  { title: 'Study Abroad Fund', slogan: 'See The World', description: 'Scholarships for students to study internationally.', category: 'community', iconColor: '#3F51B5', speed: 0.5, stakeAmount: 5 },
  // Health & Wellness (15)
  { title: 'Mental Health Awareness', slogan: 'Break The Stigma', description: 'Ending stigma around mental health issues.', category: 'community', iconColor: '#9C27B0', speed: 0.4, stakeAmount: 4 },
  { title: 'Addiction Recovery Network', slogan: 'One Day At A Time', description: 'Support network for addiction recovery.', category: 'community', iconColor: '#F44336', speed: 0.3, stakeAmount: 5 },
  { title: 'Community Gym Project', slogan: 'Fit For Free', description: 'Free outdoor gyms in every neighborhood.', category: 'sports', iconColor: '#FF5722', speed: 0.6, stakeAmount: 3 },
  { title: 'Diabetes Prevention', slogan: 'Sweet Life No Sugar', description: 'Community diabetes prevention programs.', category: 'community', iconColor: '#2196F3', speed: 0.4, stakeAmount: 4 },
  { title: 'Clean Water Initiative', slogan: 'Water Is Life', description: 'Clean drinking water for every American community.', category: 'env', iconColor: '#00BCD4', speed: 0.5, stakeAmount: 6 },
  { title: 'Free Clinic Network', slogan: 'Care Without Cost', description: 'Network of free health clinics in underserved areas.', category: 'community', iconColor: '#4CAF50', speed: 0.3, stakeAmount: 5 },
  { title: 'Yoga In Parks', slogan: 'Stretch Together', description: 'Free yoga classes in public parks.', category: 'sports', iconColor: '#E91E63', speed: 0.5, stakeAmount: 2 },
  { title: 'Healthy School Snacks', slogan: 'Fuel Young Minds', description: 'Replacing junk food with healthy options in schools.', category: 'community', iconColor: '#8BC34A', speed: 0.4, stakeAmount: 3 },
  { title: 'Sleep Health Campaign', slogan: 'Rest Is Radical', description: 'Promoting healthy sleep habits in communities.', category: 'community', iconColor: '#3F51B5', speed: 0.2, stakeAmount: 2 },
  { title: 'Eye Care For Kids', slogan: 'See Clearly', description: 'Free eye exams and glasses for children.', category: 'community', iconColor: '#00BCD4', speed: 0.3, stakeAmount: 4 },
  { title: 'Blood Donation Drive', slogan: 'Give Blood Save Lives', description: 'Organizing regular community blood drives.', category: 'community', iconColor: '#F44336', speed: 0.6, stakeAmount: 2 },
  { title: 'Outdoor Activity League', slogan: 'Nature Heals', description: 'Organized outdoor activities for mental health.', category: 'sports', iconColor: '#4CAF50', speed: 0.7, stakeAmount: 3 },
  { title: 'Elder Care Volunteers', slogan: 'Age With Dignity', description: 'Volunteer care companions for elderly.', category: 'community', iconColor: '#795548', speed: 0.2, stakeAmount: 4 },
  { title: 'Nutrition Education Hub', slogan: 'Eat Smart', description: 'Teaching nutrition and cooking skills.', category: 'community', iconColor: '#FF9800', speed: 0.4, stakeAmount: 3 },
  { title: 'Disability Access Fund', slogan: 'Access For All', description: 'Improving accessibility in public spaces.', category: 'politics', iconColor: '#607D8B', speed: 0.3, stakeAmount: 5 },
  // Justice & Rights (15)
  { title: 'Equal Justice League', slogan: 'Justice For All', description: 'Pro bono legal aid for those who cannot afford lawyers.', category: 'politics', iconColor: '#3F51B5', speed: 0.5, stakeAmount: 6 },
  { title: 'Prison Reform Now', slogan: 'Second Chances', description: 'Reforming the criminal justice system for rehabilitation.', category: 'politics', iconColor: '#607D8B', speed: 0.4, stakeAmount: 5 },
  { title: 'Wrongful Conviction Project', slogan: 'Free The Innocent', description: 'Overturning wrongful criminal convictions.', category: 'politics', iconColor: '#F44336', speed: 0.3, stakeAmount: 7 },
  { title: 'Bail Reform Alliance', slogan: 'Freedom Not Fee', description: 'Ending cash bail discrimination.', category: 'politics', iconColor: '#9C27B0', speed: 0.5, stakeAmount: 4 },
  { title: 'Tenant Rights Coalition', slogan: 'Housing Is A Right', description: 'Protecting renters from unfair evictions and rent hikes.', category: 'politics', iconColor: '#FF5722', speed: 0.6, stakeAmount: 5 },
  { title: 'LGBTQ Rights Alliance', slogan: 'Love Is Love', description: 'Fighting for LGBTQ equality and protections.', category: 'politics', iconColor: '#E91E63', speed: 0.5, stakeAmount: 4 },
  { title: 'Workers Rights Movement', slogan: 'Labor Deserves More', description: 'Better wages and working conditions for all.', category: 'politics', iconColor: '#FF9800', speed: 0.6, stakeAmount: 5 },
  { title: 'Indigenous Rights Fund', slogan: 'Honor The Land', description: 'Protecting indigenous peoples rights and sovereignty.', category: 'politics', iconColor: '#795548', speed: 0.3, stakeAmount: 6 },
  { title: 'Civic Engagement Project', slogan: 'Participate', description: 'Encouraging civic participation in local government.', category: 'politics', iconColor: '#2196F3', speed: 0.4, stakeAmount: 3 },
  { title: 'Anti Corruption Watch', slogan: 'Clean Politics', description: 'Monitoring and exposing political corruption.', category: 'politics', iconColor: '#4CAF50', speed: 0.7, stakeAmount: 5 },
  { title: 'Fair Housing Alliance', slogan: 'Home For Everyone', description: 'Fighting housing discrimination in all forms.', category: 'politics', iconColor: '#00BCD4', speed: 0.4, stakeAmount: 4 },
  { title: 'Child Labor Prevention', slogan: 'Kids Not Workers', description: 'Preventing exploitation of child labor.', category: 'politics', iconColor: '#F44336', speed: 0.3, stakeAmount: 5 },
  { title: 'Free Speech Defense', slogan: 'Speak Freely', description: 'Protecting free speech and press freedom.', category: 'politics', iconColor: '#673AB7', speed: 0.5, stakeAmount: 4 },
  { title: 'Whistleblower Protection', slogan: 'Truth Tellers', description: 'Protecting those who expose wrongdoing.', category: 'politics', iconColor: '#607D8B', speed: 0.4, stakeAmount: 6 },
  { title: 'Age Discrimination Watch', slogan: 'Experience Matters', description: 'Fighting age discrimination in the workplace.', category: 'politics', iconColor: '#9E9E9E', speed: 0.3, stakeAmount: 3 },
  // Innovation & Science (15)
  { title: 'Space Exploration Fund', slogan: 'Reach The Stars', description: 'Public funding for space exploration missions.', category: 'tech', iconColor: '#3F51B5', speed: 0.9, stakeAmount: 8 },
  { title: 'Climate Research Fund', slogan: 'Science Not Silence', description: 'Funding independent climate research.', category: 'env', iconColor: '#4CAF50', speed: 0.5, stakeAmount: 6 },
  { title: 'Biotech For Good', slogan: 'Heal With Science', description: 'Ethical biotechnology for medical breakthroughs.', category: 'tech', iconColor: '#E91E63', speed: 0.7, stakeAmount: 7 },
  { title: 'Clean Energy Research', slogan: 'Power Tomorrow', description: 'Research funding for next-gen clean energy.', category: 'env', iconColor: '#FF9800', speed: 0.6, stakeAmount: 5 },
  { title: 'Ocean Research Center', slogan: 'Deep Blue Discovery', description: 'Exploring and protecting deep ocean ecosystems.', category: 'env', iconColor: '#00BCD4', speed: 0.4, stakeAmount: 6 },
  { title: 'Citizen Science Project', slogan: 'Everyone Is A Scientist', description: 'Engaging the public in real scientific research.', category: 'tech', iconColor: '#8BC34A', speed: 0.5, stakeAmount: 3 },
  { title: 'Drone Delivery Network', slogan: 'Sky Highway', description: 'Safe drone delivery systems for remote areas.', category: 'tech', iconColor: '#FF5722', speed: 0.8, stakeAmount: 5 },
  { title: 'Electric Vehicle Fund', slogan: 'Drive Electric', description: 'Accelerating EV adoption and charging infrastructure.', category: 'env', iconColor: '#2196F3', speed: 0.6, stakeAmount: 5 },
  { title: 'Recycling Innovation', slogan: 'Rethink Waste', description: 'New technologies for recycling and upcycling.', category: 'env', iconColor: '#4CAF50', speed: 0.4, stakeAmount: 4 },
  { title: 'Brain Research Initiative', slogan: 'Mind Frontier', description: 'Funding neuroscience research for brain diseases.', category: 'tech', iconColor: '#9C27B0', speed: 0.5, stakeAmount: 7 },
  { title: 'Vertical Farming Project', slogan: 'Grow Up', description: 'Urban vertical farming to reduce food miles.', category: 'env', iconColor: '#8BC34A', speed: 0.3, stakeAmount: 4 },
  { title: 'Asteroid Mining Vision', slogan: 'Mine The Sky', description: 'Exploring asteroid mining for rare resources.', category: 'tech', iconColor: '#607D8B', speed: 1.0, stakeAmount: 8 },
  { title: 'Lab Grown Meat Fund', slogan: 'Meat Without Harm', description: 'Developing sustainable lab-grown protein.', category: 'env', iconColor: '#F44336', speed: 0.4, stakeAmount: 5 },
  { title: 'Carbon Capture Tech', slogan: 'Suck It Up', description: 'Carbon capture technology development.', category: 'env', iconColor: '#009688', speed: 0.5, stakeAmount: 6 },
  { title: 'Fusion Energy Push', slogan: 'Unlimited Power', description: 'Public-private fusion energy research.', category: 'tech', iconColor: '#FF9800', speed: 0.7, stakeAmount: 9 },
  // Culture & Media (15)
  { title: 'Local News Revival', slogan: 'Truth Nearby', description: 'Supporting local journalism and news outlets.', category: 'arts', iconColor: '#607D8B', speed: 0.4, stakeAmount: 4 },
  { title: 'Podcast For Change', slogan: 'Voices Matter', description: 'Amplifying underrepresented voices through podcasts.', category: 'arts', iconColor: '#9B59B6', speed: 0.5, stakeAmount: 3 },
  { title: 'Heritage Preservation', slogan: 'Honor The Past', description: 'Preserving historical sites and cultural heritage.', category: 'arts', iconColor: '#795548', speed: 0.2, stakeAmount: 5 },
  { title: 'Indie Game Developers', slogan: 'Play Different', description: 'Supporting independent video game creators.', category: 'tech', iconColor: '#E91E63', speed: 0.8, stakeAmount: 4 },
  { title: 'Public Radio Fund', slogan: 'Free Airwaves', description: 'Keeping public radio free and independent.', category: 'arts', iconColor: '#3498DB', speed: 0.3, stakeAmount: 3 },
  { title: 'Museum Free Days', slogan: 'Art For Everyone', description: 'Free museum admission days for all.', category: 'arts', iconColor: '#FF9800', speed: 0.2, stakeAmount: 4 },
  { title: 'Comic Book Literacy', slogan: 'Read In Color', description: 'Using comics to improve child literacy.', category: 'arts', iconColor: '#F44336', speed: 0.5, stakeAmount: 2 },
  { title: 'Cultural Exchange Program', slogan: 'Share Cultures', description: 'International cultural exchange for understanding.', category: 'community', iconColor: '#009688', speed: 0.6, stakeAmount: 4 },
  { title: 'Language Revival Project', slogan: 'Save Tongues', description: 'Preserving endangered languages.', category: 'arts', iconColor: '#673AB7', speed: 0.2, stakeAmount: 5 },
  { title: 'Documentary Film Fund', slogan: 'Real Stories', description: 'Funding important documentary films.', category: 'arts', iconColor: '#FF5722', speed: 0.4, stakeAmount: 5 },
  { title: 'Graffiti Art Program', slogan: 'Color The City', description: 'Legal graffiti walls and urban art programs.', category: 'arts', iconColor: '#E91E63', speed: 0.6, stakeAmount: 3 },
  { title: 'Book Club Network', slogan: 'Read Together', description: 'Nationwide community book club network.', category: 'arts', iconColor: '#8BC34A', speed: 0.2, stakeAmount: 2 },
  { title: 'Photography Workshop', slogan: 'Capture Moments', description: 'Free photography workshops for youth.', category: 'arts', iconColor: '#00BCD4', speed: 0.4, stakeAmount: 3 },
  { title: 'Music Festival Grant', slogan: 'Sound Of Summer', description: 'Supporting community music festivals.', category: 'arts', iconColor: '#FF9800', speed: 0.7, stakeAmount: 4 },
  { title: 'Open Mic Revolution', slogan: 'Your Stage', description: 'Free open mic nights across the nation.', category: 'arts', iconColor: '#4CAF50', speed: 0.5, stakeAmount: 2 },
  // Environment Extra (15)
  { title: 'Plastic Free Oceans', slogan: 'No More Plastic', description: 'Banning single-use plastics nationwide.', category: 'env', iconColor: '#00BCD4', speed: 0.5, stakeAmount: 5 },
  { title: 'Bee Highway Project', slogan: 'Buzzing Corridors', description: 'Creating pollinator pathways through cities.', category: 'env', iconColor: '#FFC107', speed: 0.4, stakeAmount: 3 },
  { title: 'Dark Sky Initiative', slogan: 'See The Stars', description: 'Reducing light pollution to see the night sky.', category: 'env', iconColor: '#3F51B5', speed: 0.2, stakeAmount: 4 },
  { title: 'Wetland Restoration', slogan: 'Marshes Matter', description: 'Restoring vital wetland ecosystems.', category: 'env', iconColor: '#009688', speed: 0.3, stakeAmount: 5 },
  { title: 'Noise Pollution Watch', slogan: 'Quiet Please', description: 'Reducing harmful noise pollution in cities.', category: 'env', iconColor: '#607D8B', speed: 0.2, stakeAmount: 3 },
  { title: 'Composting Campaign', slogan: 'Rot Is Right', description: 'Community composting programs.', category: 'env', iconColor: '#795548', speed: 0.3, stakeAmount: 2 },
  { title: 'Mangrove Planting', slogan: 'Roots Against Storms', description: 'Planting mangroves to protect coastlines.', category: 'env', iconColor: '#4CAF50', speed: 0.4, stakeAmount: 5 },
  { title: 'Wildlife Corridor Fund', slogan: 'Let Them Roam', description: 'Creating safe wildlife crossing corridors.', category: 'env', iconColor: '#8BC34A', speed: 0.5, stakeAmount: 4 },
  { title: 'Soil Health Project', slogan: 'Ground Up Change', description: 'Restoring soil health through regenerative methods.', category: 'env', iconColor: '#795548', speed: 0.3, stakeAmount: 3 },
  { title: 'Rainwater Harvesting', slogan: 'Catch The Rain', description: 'Community rainwater collection systems.', category: 'env', iconColor: '#2196F3', speed: 0.3, stakeAmount: 3 },
  { title: 'Invasive Species Control', slogan: 'Native Only', description: 'Removing invasive species to restore ecosystems.', category: 'env', iconColor: '#F44336', speed: 0.4, stakeAmount: 4 },
  { title: 'Green Rooftop Alliance', slogan: 'Gardens Above', description: 'Converting rooftops into green spaces.', category: 'env', iconColor: '#4CAF50', speed: 0.3, stakeAmount: 4 },
  { title: 'Clean Beach Campaign', slogan: 'Shores Deserve Better', description: 'Regular beach cleanup and conservation programs.', category: 'env', iconColor: '#00BCD4', speed: 0.5, stakeAmount: 3 },
  { title: 'Reforestation Army', slogan: 'Plant A Billion', description: 'Massive reforestation across deforested areas.', category: 'env', iconColor: '#2ECC71', speed: 0.6, stakeAmount: 6 },
  { title: 'Glacier Protection Fund', slogan: 'Freeze The Melt', description: 'Monitoring and protecting glaciers from climate change.', category: 'env', iconColor: '#B0BEC5', speed: 0.1, stakeAmount: 7 },
  // Stationary campaigns (20) — speed 0
  { title: 'NYC Freedom Monument', slogan: 'Stand For Liberty', description: 'A permanent monument for freedom in New York City.', category: 'community', iconColor: '#3F51B5', speed: 0, stakeAmount: 10 },
  { title: 'LA Peace Garden', slogan: 'Grow Peace', description: 'A permanent peace garden in Los Angeles.', category: 'env', iconColor: '#4CAF50', speed: 0, stakeAmount: 8 },
  { title: 'Chicago Memorial Wall', slogan: 'Remember Always', description: 'Memorial wall for community heroes.', category: 'community', iconColor: '#607D8B', speed: 0, stakeAmount: 6 },
  { title: 'Houston Space Museum', slogan: 'Stars Within Reach', description: 'Community space exploration museum.', category: 'tech', iconColor: '#9B59B6', speed: 0, stakeAmount: 9 },
  { title: 'Phoenix Desert Oasis', slogan: 'Water In The Desert', description: 'Desert water conservation education center.', category: 'env', iconColor: '#FF9800', speed: 0, stakeAmount: 7 },
  { title: 'Seattle Tech Archive', slogan: 'Digital History', description: 'Preserving the history of the tech revolution.', category: 'tech', iconColor: '#2196F3', speed: 0, stakeAmount: 5 },
  { title: 'Denver Mountain Watch', slogan: 'Guard The Peaks', description: 'Permanent mountain ecology monitoring station.', category: 'env', iconColor: '#795548', speed: 0, stakeAmount: 6 },
  { title: 'Miami Coral Center', slogan: 'Reef Forever', description: 'Coral reef research and education center.', category: 'env', iconColor: '#00BCD4', speed: 0, stakeAmount: 8 },
  { title: 'Boston History Hub', slogan: 'Past Meets Present', description: 'Interactive history center in Boston.', category: 'arts', iconColor: '#795548', speed: 0, stakeAmount: 5 },
  { title: 'Portland Tree Library', slogan: 'Read Under Trees', description: 'Outdoor library in a forest setting.', category: 'arts', iconColor: '#4CAF50', speed: 0, stakeAmount: 4 },
  { title: 'Nashville Sound Studio', slogan: 'Free Music Space', description: 'Free community recording studio.', category: 'arts', iconColor: '#E91E63', speed: 0, stakeAmount: 6 },
  { title: 'Atlanta Civil Rights Walk', slogan: 'March Forward', description: 'Permanent civil rights walking exhibit.', category: 'politics', iconColor: '#F44336', speed: 0, stakeAmount: 7 },
  { title: 'Detroit Art Factory', slogan: 'Create Detroit', description: 'Converted factory into community art space.', category: 'arts', iconColor: '#FF5722', speed: 0, stakeAmount: 5 },
  { title: 'San Francisco Code Lab', slogan: 'Code For Free', description: 'Free coding workspace for all.', category: 'tech', iconColor: '#3498DB', speed: 0, stakeAmount: 6 },
  { title: 'Austin Music Camp', slogan: 'Live Music Lives', description: 'Permanent live music venue and camp.', category: 'arts', iconColor: '#FF9800', speed: 0, stakeAmount: 4 },
  { title: 'Minneapolis Peace Center', slogan: 'Unity In Diversity', description: 'Community center for dialogue and peace.', category: 'community', iconColor: '#009688', speed: 0, stakeAmount: 5 },
  { title: 'Salt Lake Nature Base', slogan: 'Wild Roots', description: 'Nature education base camp.', category: 'env', iconColor: '#8BC34A', speed: 0, stakeAmount: 4 },
  { title: 'DC Democracy Hub', slogan: 'People Power', description: 'Permanent civic engagement center.', category: 'politics', iconColor: '#2196F3', speed: 0, stakeAmount: 8 },
  { title: 'Las Vegas Recovery Home', slogan: 'New Beginning', description: 'Addiction recovery and rehabilitation center.', category: 'community', iconColor: '#9C27B0', speed: 0, stakeAmount: 6 },
  { title: 'Honolulu Ocean Lab', slogan: 'Pacific Research', description: 'Permanent ocean research laboratory.', category: 'env', iconColor: '#00BCD4', speed: 0, stakeAmount: 9 },
  // Sports Extra (10)
  { title: 'Wheelchair Sports League', slogan: 'No Limits', description: 'Competitive sports for wheelchair athletes.', category: 'sports', iconColor: '#3F51B5', speed: 0.6, stakeAmount: 4 },
  { title: 'Climbing Wall Project', slogan: 'Reach Higher', description: 'Free climbing walls in community centers.', category: 'sports', iconColor: '#FF5722', speed: 0.7, stakeAmount: 3 },
  { title: 'Running For Mental Health', slogan: 'Run Your Mind', description: 'Running groups for mental health support.', category: 'sports', iconColor: '#4CAF50', speed: 0.8, stakeAmount: 2 },
  { title: 'Boxing Against Violence', slogan: 'Fight Right', description: 'Boxing programs to reduce youth violence.', category: 'sports', iconColor: '#F44336', speed: 0.7, stakeAmount: 4 },
  { title: 'Surf Therapy Program', slogan: 'Waves Of Healing', description: 'Surf therapy for veterans and at-risk youth.', category: 'sports', iconColor: '#00BCD4', speed: 0.6, stakeAmount: 3 },
  { title: 'Cycling Infrastructure', slogan: 'Pedal Forward', description: 'Better bike lanes and cycling safety.', category: 'sports', iconColor: '#8BC34A', speed: 0.5, stakeAmount: 4 },
  { title: 'Senior Fitness Program', slogan: 'Age Active', description: 'Free fitness classes for seniors.', category: 'sports', iconColor: '#9E9E9E', speed: 0.3, stakeAmount: 2 },
  { title: 'Martial Arts For Youth', slogan: 'Discipline And Respect', description: 'Free martial arts training for at-risk youth.', category: 'sports', iconColor: '#FF9800', speed: 0.7, stakeAmount: 3 },
  { title: 'Adaptive Sports Fund', slogan: 'Play Your Way', description: 'Sports equipment and programs for disabled athletes.', category: 'sports', iconColor: '#E91E63', speed: 0.5, stakeAmount: 5 },
  { title: 'Urban Parkour Academy', slogan: 'Move Free', description: 'Safe parkour training for urban youth.', category: 'sports', iconColor: '#FF5722', speed: 0.9, stakeAmount: 3 },
  // Tech Extra (10)
  { title: 'Blockchain Transparency', slogan: 'Trust The Chain', description: 'Using blockchain for government transparency.', category: 'tech', iconColor: '#673AB7', speed: 0.7, stakeAmount: 6 },
  { title: 'VR Education Lab', slogan: 'Learn In VR', description: 'Virtual reality for immersive education.', category: 'tech', iconColor: '#E91E63', speed: 0.8, stakeAmount: 5 },
  { title: 'AI Art Collective', slogan: 'Machine Muse', description: 'Exploring AI-generated art and creativity.', category: 'tech', iconColor: '#9B59B6', speed: 0.6, stakeAmount: 4 },
  { title: '3D Printing Community', slogan: 'Print The Future', description: 'Community 3D printing labs and education.', category: 'tech', iconColor: '#FF5722', speed: 0.5, stakeAmount: 3 },
  { title: 'IoT Home Safety', slogan: 'Smart And Safe', description: 'Affordable IoT safety devices for homes.', category: 'tech', iconColor: '#00BCD4', speed: 0.4, stakeAmount: 4 },
  { title: 'Autonomous Vehicle Safety', slogan: 'Drive Safe Drive Auto', description: 'Safety standards for self-driving vehicles.', category: 'tech', iconColor: '#607D8B', speed: 0.6, stakeAmount: 5 },
  { title: 'Digital Nomad Alliance', slogan: 'Work Anywhere', description: 'Rights and infrastructure for remote workers.', category: 'tech', iconColor: '#FF9800', speed: 0.8, stakeAmount: 3 },
  { title: 'Satellite Internet Fund', slogan: 'Connect From Space', description: 'Satellite internet for disconnected communities.', category: 'tech', iconColor: '#3F51B5', speed: 0.5, stakeAmount: 6 },
  { title: 'Biometric Privacy', slogan: 'My Face My Data', description: 'Protecting biometric data and facial recognition rights.', category: 'tech', iconColor: '#F44336', speed: 0.4, stakeAmount: 5 },
  { title: 'Quantum Security Alliance', slogan: 'Post Quantum Safe', description: 'Preparing cryptography for the quantum era.', category: 'tech', iconColor: '#2C3E50', speed: 0.6, stakeAmount: 7 },
];
...
async function seedBots() {
  ...
  // ══════════════════════════════════════════════════════════════════════════
  // PHASE B: Create Campaigns (~200 campaigns)
  // ══════════════════════════════════════════════════════════════════════════
